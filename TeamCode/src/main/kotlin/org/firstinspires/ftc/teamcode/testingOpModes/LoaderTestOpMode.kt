...
class LoaderTestOpMode: CommandOpModeTeleop() {
    ...
    override fun configureBindings() {
        ...
        controller.l2Pressed().whileTrue(LoaderSubsystem.holdRoulettePositionCommand(HaRotation2d.fromDegrees(50.0)))
        controller.r2Pressed().whileTrue(LoaderSubsystem.holdRoulettePositionCommand(HaRotation2d.fromDegrees(0.0)))
    }
}