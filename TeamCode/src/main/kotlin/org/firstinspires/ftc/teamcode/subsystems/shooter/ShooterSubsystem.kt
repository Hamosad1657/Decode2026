...
object ShooterSubsystem: Subsystem() {
    ...
    override fun init(newHardwareMap: HardwareMap) {
        ...
        val rightMotor = HaMotor(ShooterConstants.RIGHT_MOTOR_NAME, hardwareMap!!, MotorType.GO_BUILDA5202)
        val leftMotor = HaMotor(ShooterConstants.LEFT_MOTOR_NAME, hardwareMap!!, MotorType.GO_BUILDA5202)
        val servo = HaServoMotor(ShooterConstants.SERVO_NAME, hardwareMap!!)
