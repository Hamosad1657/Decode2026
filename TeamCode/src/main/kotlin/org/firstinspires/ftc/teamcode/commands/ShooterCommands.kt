...
fun ShooterSubsystem.setHoodAngleCommand(angle: HaRotation2d): Command = ShooterSubsystem.runOnce { setDesiredHoodAngle(angle) }

fun ShooterSubsystem.setWheelSpeedCommand(speed: AngularVelocity): Command = ShooterSubsystem.runCommand { setDesiredVelocity(speed) }
